...
const bypassMethod = new Array("register", "signup", "login", "forgotPassword", "verifyOtp", "verify_user_otp", "resend_user_otp", "updatePassword", "email", "getuserProfile", 'userDetails', 'deleteUser', 'searchUser');

//method that not require api key
const bypassHeaderKey = new Array("sendnotification", "email", 'getuserProfile');
